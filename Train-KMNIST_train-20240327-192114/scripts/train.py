...
parser.add_argument('--search', action='store_true', default=True, help='use autoaugment')
...
def main():
  ...
  model = NetworkMix(args.channels, len(classes) , args.layers, args.ops, args.kernels, input_shape)
  model = model.cuda()
